...
ImageButton1.Image = "http://www.roblox.com/asset/?id=18861408627"
...
do local GUI = game.CoreGui:FindFirstChild("DucHUB");if GUI then GUI:Destroy();end;if _G.Color == nil then
    _G.Color = Color3.fromRGB(0, 247, 255)
   end 
end

do
    local NamfonHub = workspace:FindFirstChild("DucHub")
    if NamfonHub then
        NamfonHub:Destroy()
    end
end
...
function Update:Window(text,logo,keybind)
    ...
    MapName.Text = "Ducsharelink | BLOX FRUIT"
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id=18861408627"..tostring(12523036534)
    ...
    function uitab:AddTab(text,image)
        ...
        UICorner.Parent = TabButton
            ...
            PageImage.Image = "rbxassetid://18861408627"..tostring(Image)
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id=18861408627"..tostring(12523036534)
        ...
        function main:AddSlider(text,min,max,set,callback)
            ...
            HAHA.Name = "Dit me Pc1920"
            HAHA.Parent = sliderr
            HAHA.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            HAHA.BackgroundTransparency = 1.000
            HAHA.Size = UDim2.new(0, 468, 0, 29)

            AHEHE.Name = "Dit me Roblox"
...
local Library = Update:Window("           Ducsharelink","18861408627",Enum.KeyCode.RightControl);
...
H:AddLabel("Script Vip by Ducsharelink Hub")

H:AddSeperator("Credit")



H:AddButton("Copy Link Giới thiệu",function()
setclipboard("https://guns.lol/ducsharelink")
end)

H:AddButton("Copy Link Shop của Admin",function()
setclipboard("https://trumacc.vn/shop/ducsharelink")
end)
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=18861408627",
							Duration = 2.5
						})
					end
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep",true) == 1 then
...
M:AddToggle("Auto Find Full Moon",_G.AutoFindFullmoon,function(value)
 ...
 spawn(function()
        while wait() do
            ...
            if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=18861408627" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                wait(2.0)
                game.StarterGui:SetCore("SendNotification", {
            ...
            elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=18861408627" then
                Hop()
                game.StarterGui:SetCore("SendNotification", {
					Title = "Ducsharelink Hub", 
...
Misc:AddButton("Kaitun Cap", function(value)
		...
		for k,v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..v,true) == 1 then 
				...
				huhu.Image = "rbxassetid://18861408627"
...
print("Ducsharelink Hub Load Complete")

game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=18861408627";
      Title = "Ducsharelink Hub", 
      Text = "Địt mẹ chúng mày đã sử dụng Script của tao!!";
})
wait(3)
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=18861408627";
      Title = "Ducsharelink Hub", 
      Text = "made by @ducsharelink đẹp trai khoai to วะ";
})
